...
| `and_b(X,Y)`                 |                                                                     | s=s<sub>X</sub> or s<sub>Y</sub>; f=f<sub>X</sub>f<sub>Y</sub> or s<sub>X</sub>f<sub>X</sub> or s<sub>Y</sub>f<sub>Y</sub>; e=e<sub>X</sub>e<sub>Y</sub>s<sub>X</sub>s<sub>Y</sub>
| `or_b(X,Z)`                  | e<sub>X</sub> and e<sub>Z</sub> and (s<sub>X</sub> or s<sub>Z</sub>)| s=s<sub>X</sub>s<sub>Z</sub>; e
